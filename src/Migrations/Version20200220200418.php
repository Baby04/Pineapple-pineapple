 ...
 */
final class Version20200220200418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE reset_token reset_token VARCHAR(60) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE reset_token reset_token VARCHAR(60) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
