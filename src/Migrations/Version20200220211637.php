 ...
 */
final class Version20200220211637 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(60) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, CHANGE reset_token reset_token VARCHAR(60) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
    }
}
